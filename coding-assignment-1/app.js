...
app.get("/todo/", checkRequestsQueries, async (request, response) => {
...
//GET Todo API-2
app.get("/todo/:todoId", checkRequestsQueries, async (request, response) => {
...
app.get("/agenda/", checkRequestsQueries, async (request, response) => {
  ...
  const todoArray = await db.all(selectDuaDateQuery);
...
//Add Todo API-4
app.post("/todo/", checkRequestsBody, async (request, response) => {
...
//Update Todo API-5
app.put("/todo/:todoId/", checkRequestsBody, async (request, response) => {
  const { todoId } = request;
